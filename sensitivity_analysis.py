"""
    this is a general purpose sensitivity analysis script.
    You have all the parameters explicitly written, you manually modify each of them and you save the results.
    Multiple runs are performed and the results are averaged, finally, you can find either on the console or
    on logger.txt the results of this particular run
"""
